...
const menuMiddleEmpty = require("../assets/images/menu-middle-empty.jpg");
const kabak = require("../assets/images/kabak.jpg");
const menuLeft = require("../assets/images/menu-left.jpg");
