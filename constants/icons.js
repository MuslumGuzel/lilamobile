...
export const addAPhoto = require("../assets/icons/add_a_photo.png");
export const document = require("../assets/icons/document.png");
export const menuBoxed = require("../assets/icons/menu-boxed.png");
export const plus = require("../assets/icons/vector.png");
